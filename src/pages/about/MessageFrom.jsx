        ...
        <section className="message-page">
          ...
          <div className="message-hero">
            ...
            <div className="section-title hero-text">
              <h2>Message from <span className="highlight">the Chairman</span></h2>
              <p className="sub-title">A tradition of service, a future of growth.</p>
            </div>
          </div>
          ...
          <div className="message-content">
            ...
            <p>
              ...
              and collective progress. Every achievement we have celebrated is
              the result of your unwavering faith and active participation.
            </p>
            ...
            <p>
              ...
              decision we take contributes positively to the lives of our
              members.
            </p>
            ...
            <p>
              Let us move forward with unity, vision, and purpose.
            </p>
